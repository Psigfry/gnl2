...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/16 12:57:23 by psigfry           #+#    #+#             */
/*   Updated: 2021/09/16 12:57:23 by psigfry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static void ft_bufferization(char **line,int fd, char *buff)
// {
// 	int		byte;

// 	while((byte = read(fd, buff, 10)))
// 	{
// 		buff[byte] = '\0';
